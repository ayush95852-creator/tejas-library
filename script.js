...
        navbar.style.background = 'rgba(15, 15, 16, 0.95)';
        navbar.style.boxShadow = '0 4px 20px rgba(0, 0, 0, 0.3)';
    } else {
        navbar.style.background = 'rgba(15, 15, 16, 0.8)';
...
// ============ Hover Effects ============
document.querySelectorAll('.pricing-card, .facility-card, .exam-card').forEach(card => {
...
// Uncomment if you want scroll snapping
/*
...
console.log('✨ TEJAS LIBRARY Website Loaded Successfully!');
